// Formal Client Frame — kop 3 kolom identik FormalFrame, footer HANYA TTD klien/saksi
// Dipakai instansi dgn kopStyle: "formalClient"
...
export default function FormalClientFrame({
        ...
        {showFooterTtd && (
          <>
            ...
            <div className="laporan-section laporan-footer">
              <ClientOnlySignature data={data} instansi={instansi} ttd_client={ttd_client} />
            </div>
          </>
        )}
      </div>
...
// ─── Kop tabel 3 kolom (identik FormalFrame) ─────────────────────────────────
...
// ─── Footer hanya TTD klien/saksi (3 kolom: No Agenda | NIDI | Saksi) ────────
function ClientOnlySignature({ data, instansi, ttd_client }) {
